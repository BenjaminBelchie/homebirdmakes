...
import { Montserrat, Merriweather, Arvo } from "next/font/google";
import { cn } from "@/lib/utils";

const merriweatherHeading = Merriweather({subsets:['latin'],variable:'--font-heading'});

const arvo = Arvo({subsets:['latin'], weight: ['400', '700'], variable:'--font-sans'});
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <html lang="en" className={cn("font-sans", arvo.variable, merriweatherHeading.variable)}>
      <body>
        <ClerkProvider>
